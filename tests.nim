...
suite "Test Suite for TinyRe":
  ...
  test "Regex engine semantics":
    check:
      ...
      output(re"a{2}b", "aaaaaaab") == "(5,8)"
      output(re"a{2,}b", "aaaaaaab") == "(0,8)"
      output(re"a{2,3}b", "aaaaaaab") == "(4,8)"
      output(re"a{0}b", "b") == "(0,1)"
      output(re"a{0,}b", "b") == "(0,1)"
      output(re"a{0,2}b", "b") == "(0,1)"
      output(re"a{1}b", "b") == ""
      output(re"a{1,}b", "b") == ""
      output(re"a{1,3}b", "b") == ""
      output(re"(.?){0,}", "aaa") == "(0,3)(2,3)"
      output(re"(.?){1,}", "aaa") == "(0,3)(2,3)"
      output(re"(.?){2,}", "aaa") == "(0,3)(2,3)"
      output(re"(.?){3,}", "aaa") == "(0,3)(2,3)"
      output(re"(.?){0,}?", "aaa") == "(0,0)(?,?)"
      output(re"(.?){1,}?", "aaa") == "(0,1)(0,1)"
      output(re"(.?){2,}?", "aaa") == "(0,2)(1,2)"
      output(re"(.?){3,}?", "aaa") == "(0,3)(2,3)"
      output(re"a{0}", "aaaa") == "(0,0)"
      output(re"a{1}", "aaaa") == "(0,1)"
      output(re"a{0,}", "aaaa") == "(0,4)"
      output(re"a{1,}", "aaaa") == "(0,4)"
      output(re"a{1,3}", "aaaa") == "(0,3)"
      output(re"a{0}?", "aaaa") == "(0,0)"
      output(re"a{1}?", "aaaa") == "(0,1)"
      output(re"a{0,}?", "aaaa") == "(0,0)"
      output(re"a{1,}?", "aaaa") == "(0,1)"
      output(re"a{1,3}?", "aaaa") == "(0,1)"
      output(re"a{0}b", "aaaab") == "(4,5)"
      output(re"a{1}b", "aaaab") == "(3,5)"
      output(re"a{0,}b", "aaaab") == "(0,5)"
